...
kind create cluster --config ../kind-cluster/kindconfig-v1250.yaml      # Create kind cluster 125
sleep 1
...
sleep 120
kubectl create -f ../kind-cluster/metallb-v0139-ipaddress-pool-3.yaml --context kind-125
sleep 0.5
