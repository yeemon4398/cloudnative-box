...
kind create cluster --config ../config-files/kindconfig-v1244.yaml      # Create kind cluster 124
sleep 1
...
sleep 120
kubectl create -f ../config-files/metallb-v0139-ipaddress-pool-2.yaml --context kind-124
sleep 0.5
